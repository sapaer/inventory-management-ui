...
// Notifications aren't listed here — that's what the bell button
// (NotificationBell.jsx) next to this menu is for.
const ITEMS = [
 ...
 * Profile / Store details / Settings / Logout. This is the single mobile
 * nav-shell used everywhere (Layout's signed-in app shell and SiteHeader's
 * public pages alike): Home/Inventory/Update/Insights live in the app-wide
 * bottom tab bar and alerts live behind the bell button next to this menu,
 * so there's no separate hamburger drawer anymore.
 */
